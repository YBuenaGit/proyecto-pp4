...
const toneByStatus: Record<string, string> = {
  ...
  EN_ANALISIS: "border-[#9fd3e3] bg-[#c4e7f3] text-[#064d60]",
  DERIVADO: "border-[#b8daff] bg-[#cce5ff] text-[#004085]",
  EN_GESTION: "border-[#9fd3e3] bg-[#c4e7f3] text-[#064d60]",
  ...
  ENTREGADO: "border-[#c3e6cb] bg-[#d4edda] text-[#155724]",
  ...
  MEDIA: "border-[#9fd3e3] bg-[#c4e7f3] text-[#064d60]",
