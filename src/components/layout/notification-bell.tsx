...
export function NotificationBell({ notifications }: { notifications: NavbarNotificationPayload }) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open ? (
        <div className="absolute right-0 top-full z-50 mt-2 w-[min(23rem,calc(100vw-1.5rem))] overflow-hidden rounded-sm border border-[#dee2e6] bg-white shadow-xl">
          ...
          {notifications.items.length ? (
            <>
              <div className={cn("overflow-y-auto py-1", expanded ? "max-h-[70vh]" : "max-h-[26rem]")}>
