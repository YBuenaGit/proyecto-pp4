...
async function main() {
  ...
  const catalogData = [
    ...
    ["dispatch_category", "DESPACHO", "PEDIDO_ACTA_TRIBUNAL_FALTA", "Pedido de acta por tribunal de falta"],
    ...
    ["dispatch_area", "DESPACHO", "HONORABLE_TRIBUNAL_DE_FALTA", "Honorable tribunal de falta"],
    ["dispatch_area", "DESPACHO", "OFICIOS_JUDICIALES", "Oficios judiciales"],
